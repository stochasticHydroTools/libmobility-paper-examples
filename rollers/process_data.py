...
def get_tstar_distributions(
    ...
    for isDeterministic in [True, False]:
        ...
        for i in range(n_runs):
            ...
            # note: k_min can be tricky to set to robustly pick out t* even though the peak is very clear visually.
            # looking at plots generated by psd.py can help.
            k_min = 0.15 if lowHeight else 0.10
            k_max = 0.25
            percentile = 30.0
